...
from RuleValidator import RuleValidator, RuleViolation


class RuleValidatorTestCase(unittest.TestCase):
    def test_conflicting_verbs(self):
        rule_validator = RuleValidator(test_spec_path('conflicting_http_verbs_spec'))
    ...
    def test_missing_amazon_integration(self):
        rule_validator = RuleValidator(test_spec_path('no_amazon_integration'))
    ...
    def test_no_cors_present(self):
        rule_validator = RuleValidator(test_spec_path('options_no_cors_present'))
    ...
    def test_cors_not_enough_verbs(self):
        rule_validator = RuleValidator(test_spec_path('options_cors_inconsistent_verbs'))
    ...
    def test_cors_inconsistent_headers(self):
        rule_validator = RuleValidator(test_spec_path('options_cors_incosistent_headers'))
    ...
    def test_authorizer_absent_but_referenced_in_request_params(self):
        rule_validator = RuleValidator(test_spec_path('authorizer_referenced_but_missing'))
    ...
    def test_no_authorizer_on_options(self):
        rule_validator = RuleValidator(test_spec_path('no_authorizer_on_options'))
    ...
    def test_ok_spec(self):
        rule_validator = RuleValidator(test_spec_path('ok_spec'))
        rule_validator.add_rule(ConflictingHttpVerbsRule())
